...
public class ps extends Frame 
    ...
    */
	...
	r = tv.TV.r; 
        ...
        String banner = "Powell-Sabin joint macro";
        write(banner);
	...
	setLayout(new GridLayout(4,1));
        ...
        setSize(900,200);
        setTitle("Powell-Sabin joint macro");
        setVisible(false);
    }
	...
	for (int i = 0; i < s[0]; i++) {
	    ...
	    tv.Config.addSuper(1,10);
	}
	/* centroid */
	for (int i = 0; i < s[1]; i++) {
	    tv.Config.addSuper(1,4);
	    tv.Config.addSuper(1,9);
	}
	/* face entroids: */
	for (int i = 0; i < s[2]; i++) {
	    ...
	    tv.Config.addSuper(1,11);
	    tv.Config.addSuper(1,12);
	    tv.Config.addSuper(1,13);
	}
	/* boundary edges */
	for (int i = 0; i < s[3]; i++) {
	...
	for (int i = 0; i < s[4]; i++) {
	    ...
	    tv.Config.addSuper(2,tv.Config.findEdge(10,9));
	}
	...
	for (int i = 0; i < s[5]; i++) {
	    ...
	    tv.Config.addSuper(2,tv.Config.findEdge(11,0));
	    tv.Config.addSuper(2,tv.Config.findEdge(11,1));
	    tv.Config.addSuper(2,tv.Config.findEdge(11,10));
	    tv.Config.addSuper(2,tv.Config.findEdge(12,1));
	    tv.Config.addSuper(2,tv.Config.findEdge(12,2));
	    tv.Config.addSuper(2,tv.Config.findEdge(12,10));
	    tv.Config.addSuper(2,tv.Config.findEdge(13,0));
	    tv.Config.addSuper(2,tv.Config.findEdge(13,2));
	    tv.Config.addSuper(2,tv.Config.findEdge(13,10));
	}
	...
	for (int i = 0; i < s[6]; i++) {
	    ...
	    tv.Config.addSuper(2,tv.Config.findEdge(9,11));
	    tv.Config.addSuper(2,tv.Config.findEdge(9,12));
	    tv.Config.addSuper(2,tv.Config.findEdge(9,13));
	}
	...
	for (int i = 0; i < s[7]; i++) {
	    ...
	    tv.Config.addSuper(3,tv.Config.findFace(0,1,9));
	    tv.Config.addSuper(3,tv.Config.findFace(0,2,9));
	    tv.Config.addSuper(3,tv.Config.findFace(0,10,9));
	    tv.Config.addSuper(3,tv.Config.findFace(1,2,9));
	    tv.Config.addSuper(3,tv.Config.findFace(1,10,9));
	    tv.Config.addSuper(3,tv.Config.findFace(2,10,9));
	}
	...
	for (int i = 0; i < s[8]; i++) {
	    ...
	    tv.Config.addSuper(3,tv.Config.findFace(1,9,8));
	    tv.Config.addSuper(3,tv.Config.findFace(2,9,8));
	    tv.Config.addSuper(3,tv.Config.findFace(0,9,8));
	    tv.Config.addSuper(3,tv.Config.findFace(1,9,11));
	    tv.Config.addSuper(3,tv.Config.findFace(10,9,11));
	    tv.Config.addSuper(3,tv.Config.findFace(0,9,11));
	    tv.Config.addSuper(3,tv.Config.findFace(2,9,13));
	    tv.Config.addSuper(3,tv.Config.findFace(10,9,13));
	    tv.Config.addSuper(3,tv.Config.findFace(0,9,13));
	    tv.Config.addSuper(3,tv.Config.findFace(2,9,12));
	    tv.Config.addSuper(3,tv.Config.findFace(10,9,12));
	    tv.Config.addSuper(3,tv.Config.findFace(1,9,12));
	}
	tv.Config.drawIt();
    }
    ...
    void countVtcs() {
		...
		for (int j = 0; j < nDps; j++) {
			...
			if (tv.Config.dps[j][0] >= d-R ||
			    ...
			    tv.Config.dps[j][10] >= d-R) {
			    tv.Config.process(j);
			}
		    }
		}
	    }
	    counting = counting + 5*(R+3)*(R+2)*(R+1)/6;
    ...
    void countEdgs() {
		...
		for (int nu = 0; nu < 3; nu++) {
		    int k = tv.Config.findEdge(nu,10);
		    int i = tv.Config.edges[k][0];
		    int j = tv.Config.edges[k][1];
		    for (int l = 0; l < nDps; l++) {
			if (tv.Config.dps[l][V+1] == 1) {
    ...
    void countFcs() {
		...
		if (delta == 7*bigfaceCount) {
		    s = s + " --- looks OK ";
		}
		else {
		    s = s + " --- face error " + delta + " " + 7*bigfaceCount;
		    Ferror = true;
		}
		Status.setText(s);
		write(s);

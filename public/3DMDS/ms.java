...
public class ms extends Frame 
    ...
    1: V4 interior vertex
    2: E01 bdr edge
    3: E04 edge from b vtx to int vtx
    4: E45 edge from int vtx to int vtx
    5: F014 face 2 bdry vtcs
    6: F045 face 1 bdry vtx
    7: F456 face 0 bdr vtcs
    ...
    */
	...
	d = tv.TV.d; 
        ...
        sample[2] = new Label("E01:");
        sample[3] = new Label("E04:");
        sample[4] = new Label("E45:");
        sample[5] = new Label("F014:");
        sample[6] = new Label("F045:");
        sample[7] = new Label("F456:");

        String banner = "MS macro";
        write(banner);
	...
	/* from boundary vertex to interior vertex */
	for (int i = 0; i < s[3]; i++) {
	...
	/* a face containing a boundary edge and and interior point */
	for (int i = 0; i < s[5]; i++) {
	    ...
	    tv.Config.addSuper(3,tv.Config.findFace(1,3,6));
	    tv.Config.addSuper(3,tv.Config.findFace(1,2,4));
	    tv.Config.addSuper(3,tv.Config.findFace(1,2,7));
	    tv.Config.addSuper(3,tv.Config.findFace(0,3,5));
	    tv.Config.addSuper(3,tv.Config.findFace(0,3,6));
	    tv.Config.addSuper(3,tv.Config.findFace(0,2,5));
	    tv.Config.addSuper(3,tv.Config.findFace(0,2,7));
	    tv.Config.addSuper(3,tv.Config.findFace(0,1,6));
	    tv.Config.addSuper(3,tv.Config.findFace(0,1,7));
	}
	/* a face containing one boundary vertex */
	for (int i = 0; i < s[6]; i++) {
	    tv.Config.addSuper(3,tv.Config.findFace(3,4,5));
	    tv.Config.addSuper(3,tv.Config.findFace(3,4,6));
	    tv.Config.addSuper(3,tv.Config.findFace(3,5,6));
	    tv.Config.addSuper(3,tv.Config.findFace(2,4,5));
	    tv.Config.addSuper(3,tv.Config.findFace(2,4,7));
	    tv.Config.addSuper(3,tv.Config.findFace(2,5,7));
	    tv.Config.addSuper(3,tv.Config.findFace(1,4,6));
	    tv.Config.addSuper(3,tv.Config.findFace(1,4,7));
	    tv.Config.addSuper(3,tv.Config.findFace(1,6,7));
	    tv.Config.addSuper(3,tv.Config.findFace(0,5,6));
	    tv.Config.addSuper(3,tv.Config.findFace(0,5,7));
	    tv.Config.addSuper(3,tv.Config.findFace(0,6,7));
	}
	/* a face containing no boundary vertex */  
	for (int i = 0; i < s[7]; i++) {
	    ...
	    tv.Config.addSuper(3,tv.Config.findFace(5,6,7));
	}
	tv.Config.drawIt();
    }
